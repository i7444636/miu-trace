const CACHE="miu-trace-shell-v10";
const ASSETS=["./","index.html","sources.html","config.js","assets/app.css","assets/details.css","assets/app.js","manifest.webmanifest","data/beta-events.json"];
